...
namespace Altinn.SystemAdmin.Maskinporten.Services
{
    /// <summary>
    ...
    public class MaskinportenService: IMaskinportenService
    {
        ...
        public MaskinportenService(HttpClient httpClient, MaskinportenConfig maskinPortenConfig)
        {
            httpClient.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
            _client = httpClient;
            _maskinPortenConfig = maskinPortenConfig;
        }
        ...
        private async Task<TokenResponse?> PostToken(string environment, FormUrlEncodedContent bearer)
        {
            ...
            catch (Exception e)
            {
                ...
                throw new TokenRequestException(e.Message);
            }
        }
