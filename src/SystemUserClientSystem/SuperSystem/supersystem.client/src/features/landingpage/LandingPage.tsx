            ...
            <div className="min-h-screen bg-gray-100">
                ...
                <section className="bg-smartcloud text-white py-12">
                    <div className="container mx-auto px-4 text-center">
                        <div className="grid grid-cols-1 sm:grid-cols-4 lg:grid-cols-2 gap-8">
                            <div className="shadow-lg p-2 ">
                                <h3 className="text-xl font-semibold mb-4">SmartBasic</h3>
                                <CheckmarkIcon title="a11y-title" fontSize="1.5rem" /> SmartRegnskap<br />
                                <CheckmarkIcon title="a11y-title" fontSize="1.5rem" /> Systemtilgang i Altinn<br />
                                  
                            </div>
                            <div className="shadow-lg p-2 ">
                                <h3 className="text-xl font-semibold mb-4">SmartStandard</h3>
                                <CheckmarkIcon title="a11y-title" fontSize="1.5rem" /> SmartRegnskap<br />
                                <CheckmarkIcon title="a11y-title" fontSize="1.5rem" /> SmartLønn<br />
                                <CheckmarkIcon title="a11y-title" fontSize="1.5rem" /> Systemtilgang i Altinn<br />
                            </div>
                            <div className="shadow-lg p-2 ">
                                ...
                                <CheckmarkIcon title="a11y-title" fontSize="1.5rem" /> SmartRegnskap<br />
                                <CheckmarkIcon title="a11y-title" fontSize="1.5rem" /> SmartLønn<br />
                                <CheckmarkIcon title="a11y-title" fontSize="1.5rem" /> SmartHR<br />
                                <CheckmarkIcon title="a11y-title" fontSize="1.5rem" /> Systemtilgang i Altinn<br />
                            </div>
                            <div className="shadow-lg p-2 ">
                                <h3 className="text-xl font-semibold mb-4">SmartPremium</h3>
                                <CheckmarkIcon title="a11y-title" fontSize="1.5rem" /> SmartRegnskap og SmartHR<br />
                                <CheckmarkIcon title="a11y-title" fontSize="1.5rem" /> SmartCRM<br />
                                <CheckmarkIcon title="a11y-title" fontSize="1.5rem" /> SmartFleet og SmartLogistikk<br />
                                <CheckmarkIcon title="a11y-title" fontSize="1.5rem" /> Systemtilgang i Altinn<br />
                            </div>
                        </div>
                    </div>
